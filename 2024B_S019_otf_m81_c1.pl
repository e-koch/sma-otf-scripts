...
################## Priming ################################
#
# observe -s M81_C_1 -r 09:55:51.7  -d +69:01:41.3 -e 2000 -v -30
# dopplerTrack -S M81_C_1 -r 230.538 -u -s1 -f 0.0 -h 10 -R h -r 230.538 -u -s1 -f 0.0 -h 10
#
################## Pointing ###############################
#
...
$targ0="M81_C_1 -r 09:55:51.7  -d +69:01:41.3 -e 2000 -v -30";
...
$cal0="0958+655"; $ncal0="6"; #for M81_C_1
$cal1="0841+708"; $ncal1="6"; #for M81_C_1
...
print "----- M81_C_1  science target observe loop -----\n";
...
#
# $souString should be a string identifying the source to observe, e.g. "M81_C_1".
#
...
sub observeTargetOTF{
    ...
    #command("otf -v 3 -l 120 -y 10 -n 13 -e -w"); # for M81_C_1 initial test
