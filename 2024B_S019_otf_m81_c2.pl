...
################## Priming ################################
#
# observe -s M81_C_2 -r 09:55:10.1  -d +69:06:55.3 -e 2000 -v -30
# dopplerTrack -S M81_C_2 -r 230.538 -u -s1 -f 0.0 -h 10 -R h -r 230.538 -u -s1 -f 0.0 -h 10
#
################## Pointing ###############################
#
...
$targ0="M81_C_2 -r 09:55:10.1  -d +69:06:55.3 -e 2000 -v -30";
$nmaps0="22"; # for M81-group
#  -- loops for up to 11 h
$rowLength0 = "390";  # arcsec
...
$cal0="0958+655"; $ncal0="6"; #for M81_C_2
$cal1="0841+708"; $ncal1="6"; #for M81_C_2
...
print "----- M81_C_2  science target observe loop -----\n";
...
#
# $souString should be a string identifying the source to observe, e.g. "M81_C_2".
#
...
sub observeTargetOTF{
    ...
    #command("otf -v 3 -l 120 -y 10 -n 13 -e -w"); # for M81_C_2 initial test
